...
// was not loaded in eager-loading.
func (e UserEdges) FoodsOrErr() ([]*Food, error) {
	if e.loadedTypes[1] {
		return e.Foods, nil
	}
...
// QueryFoods queries the foods edge of the User.
func (u *User) QueryFoods() *FoodQuery {
	return (&UserClient{config: u.config}).QueryFoods(u)
}
