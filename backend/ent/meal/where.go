...
func Name(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameEQ(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldName), v))
	})
}
...
func NameNEQ(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameIn(vs ...string) predicate.Meal {
...
func NameNotIn(vs ...string) predicate.Meal {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NameGT(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameGTE(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameLT(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameLTE(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameContains(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameHasPrefix(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameHasSuffix(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameEqualFold(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func NameContainsFold(v string) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func HasMealplans() predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
...
func HasMealplansWith(preds ...predicate.Mealplan) predicate.Meal {
	return predicate.Meal(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
