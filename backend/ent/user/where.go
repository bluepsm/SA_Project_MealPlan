...
func HasMealplans() predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasMealplansWith(preds ...predicate.Mealplan) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasFoods() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FoodsTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, FoodsTable, FoodsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasFoodsWith(preds ...predicate.Food) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
